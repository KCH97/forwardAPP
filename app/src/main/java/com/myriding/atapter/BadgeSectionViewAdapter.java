...
public class BadgeSectionViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public BadgeSectionViewAdapter(Context context, int sectionResourceId, int textResourceId, RecyclerView recyclerView, RecyclerView.Adapter baseAdapter) {
    ...
    public void setSections(Section[] sections) {
        ...
        Arrays.sort(sections, new Comparator<Section>() {
            ...
            public int compare(Section section, Section t1) {
                return (section.firstPosition == t1.firstPosition)
                        ? 0
